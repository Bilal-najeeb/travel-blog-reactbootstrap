...
import modalToggleSlice, { setLocToggle } from '../../../slices/modalToggleSlice'
...
const AddLocationModal = () => {
  ...
  const submitHandler = async (e) => {
    ...
    if (isValid) {
      try {
        const res = await axios.post('http://localhost:3000/api/locations/createlocation', {
          name: name,
        });

        dispatch(setLocToggle());
  ...
  return (
    <div className='addNewUser text-white'>
                          ...
                          <div className='newUser-Wrapper'>
                            <Button variant='danger' className='clsbtn' onClick={()=>dispatch(setLocToggle())}>X</Button>
